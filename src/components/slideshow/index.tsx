...
/**
 *
 * @param {React.ReactNode} children - Los elementos que se mostrarán 
 * @param {boolean} loading - Si la presentación de diapositivas se está cargando o no (si se usa con una API)
 * @param {number} speed - La velocidad de la transición en milisegundos
 * @param {number} number - Las diapositivas que se moverán a la vez
 * @param {boolean} slideAll - Si las diapositivas deben moverse todas a la vez o no
 * @returns {JSX.Element}
 */
